...
import { createFinaleController } from "./appendFinaleToTimeline";
...
type UseShowreelTimelineOptions = {
  sectionRef: RefObject<HTMLElement | null>;
  typedRef: RefObject<HTMLSpanElement | null>;
  finaleRefs: ShowreelFinaleRefs;
...
export function useShowreelTimeline({
  sectionRef,
  typedRef,
  finaleRefs,
  scrollDirectionRef,
  ...
  useGSAP(
    () => {
      ...
      const itemsA = gsap.utils.toArray<HTMLElement>(
        ...
        const finale = createFinaleController({
          section,
          refs: finaleRefs,
          scrollDirectionRef,
          lottieAnimRef,
        ...
        finale.appendToTimeline(tl, ctaStart);
